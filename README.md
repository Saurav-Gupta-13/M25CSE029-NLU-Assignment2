...
**Author:** Saurav Gupta (Roll No: M25CSE029)  
...
```text
📦 M25CSE029-NLU-Assignment2
 ┣ 📜 M25CSE029_NLU_Prob1.ipynb     # Full code pipeline for Word Embeddings (Task 1 to Task 4)
 ┣ 📜 M25CSE029_NLU_Prob2.ipynb     # Full code pipeline for Sequence Modeling (Task 0 to Task 3)
